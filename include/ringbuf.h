...
extern void      ringbuf_add_gatingseqs(ringbuf_t ringbuf, seq_t *gatingseqs, size_t length);
...
extern seqbar_t  ringbuf_new_bar(ringbuf_t ringbuf, seq_t *seqs, size_t length);
